        ...
        for(j = 0; j <= 12; j += 4){
            for(k = j; k < 3 + j; k++){
                if(allLis[k].innerHTML&&allLis[k + 1].innerHTML){
                    if(allLis[k].children[0].innerHTML === allLis[k + 1].children[0].innerHTML){
                        flag = false;
                        break;
                    }
                }
        ...
        for(j = 0; j < 4; j++){
            for(k = j; k < 12 + j; k += 4){
                if(allLis[k].innerHTML&&allLis[k + 4].innerHTML){
                    if(allLis[k].children[0].innerHTML === allLis[k + 4].children[0].innerHTML){
                        flag = false;
                        break;
                    }
                }
...
function changeLeft(){
    ...
    for(k = 0; k < 3; k++){
        if(allLis[k].innerHTML&&allLis[k+1].innerHTML){
            if(allLis[k].children[0].innerHTML === allLis[k + 1].children[0].innerHTML){
                countNum = parseInt(allLis[k].children[0].innerHTML) + parseInt(allLis[k + 1].children[0].innerHTML);
...
function changeTop(){
    ...
    for(k = 0; k < 12; k += 4){
        if(allLis[k].innerHTML&&allLis[k + 4].innerHTML){
            if(allLis[k].children[0].innerHTML === allLis[k + 4].children[0].innerHTML){
                countNum = parseInt(allLis[k].children[0].innerHTML) + parseInt(allLis[k + 4].children[0].innerHTML);
                switchbgColor(countNum, allLis[k].children[0]);
                allLis[k].children[0].innerHTML = countNum;
